...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("言灵宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.186.85.101"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 29666;
pub const RELAY_PORT: i32 = 29667;
pub const WS_RENDEZVOUS_PORT: i32 =29668;
pub const WS_RELAY_PORT: i32 = 29669;
