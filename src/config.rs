...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.186.85.97"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28866;
pub const RELAY_PORT: i32 = 28867;
pub const WS_RENDEZVOUS_PORT: i32 =28868;
pub const WS_RELAY_PORT: i32 = 28869;
