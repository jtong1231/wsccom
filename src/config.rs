...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("星云议".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.101.179.18"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28966;
pub const RELAY_PORT: i32 = 28967;
pub const WS_RENDEZVOUS_PORT: i32 =28968;
pub const WS_RELAY_PORT: i32 = 28969;
