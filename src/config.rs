...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.91.116.171"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28666;
pub const RELAY_PORT: i32 = 28667;
pub const WS_RENDEZVOUS_PORT: i32 =28668;
pub const WS_RELAY_PORT: i32 = 28669;
