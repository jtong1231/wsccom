...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("严议芸".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.186.85.102"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 29266;
pub const RELAY_PORT: i32 = 29267;
pub const WS_RENDEZVOUS_PORT: i32 =29268;
pub const WS_RELAY_PORT: i32 = 29269;
