...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.101.179.19"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 29566;
pub const RELAY_PORT: i32 = 29567;
pub const WS_RENDEZVOUS_PORT: i32 =29568;
pub const WS_RELAY_PORT: i32 = 29569;
