...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("炎灵通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.101.179.21"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 29766;
pub const RELAY_PORT: i32 = 29767;
pub const WS_RENDEZVOUS_PORT: i32 =29768;
pub const WS_RELAY_PORT: i32 = 29769;
