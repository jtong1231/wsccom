...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.91.116.173"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28466;
pub const RELAY_PORT: i32 = 28467;
pub const WS_RENDEZVOUS_PORT: i32 =28468;
pub const WS_RELAY_PORT: i32 = 28469;
